...
host_death_chance = [0.8]
mutualist_death_chance = [0.6, 0.65, 0.7, 0.75]
...
for a in seeds:
    for b in host_death_chance:
        for c in mutualist_death_chance:
            command_str = './symbulation_sgp -SEED '+str(a)+ ' -BASE_DEATH_CHANCE ' +str(b)+ ' -MUTUALIST_DEATH_CHANCE '+str(c)+' -FILE_NAME _MUTUALISTDEATH'+str(c)+'_HOSTDEATH'+str(b)
            settings_filename = "Output"+"_MUTUALISTDEATH"+str(c)+"_HOSTDEATH"+str(b)+"_SEED"+str(a)+".data"
