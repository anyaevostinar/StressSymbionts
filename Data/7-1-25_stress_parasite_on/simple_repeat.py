...
parasite_death_chance = [0.7, 0.75, 0.8, 0.85]
...
for a in seeds:
    for b in host_death_chance:
        for c in parasite_death_chance:
            command_str = './symbulation_sgp -SEED '+str(a)+ ' -BASE_DEATH_CHANCE ' +str(b)+ ' -PARASITE_DEATH_CHANCE '+str(c)+' -FILE_NAME _PARASITEDEATH'+str(c)+'_HOSTDEATH'+str(b)
            settings_filename = "Output"+"_PARASITEDEATH"+str(c)+"_HOSTDEATH"+str(b)+"_SEED"+str(a)+".data"
