...
for a in seeds:
    for b in stress_type:
        command_str = './symbulation_sgp -SEED '+str(a)+ ' -STRESS_TYPE ' +str(b)+ ' -FILE_NAME _STRESS_TYPE'+str(b)
        settings_filename = "Output"+"_STRESSTYPE"+str(b)+"_SEED"+str(a)+".data"

        print(command_str)
        cmd(command_str+" > "+settings_filename)
        
    command_str = './symbulation_sgp -SEED '+str(a)+ ' -START_MOI 0' +' -FILE_NAME _NO_SYMS'
    settings_filename = "Output"+"_NO_SYMS"+"_SEED"+str(a)+".data"
