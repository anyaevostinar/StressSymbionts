...
folder = '../../Data/7-1-25_stress_mutualist_on/'

seeds = range(1, 30)
treatments = [0.6, 0.3, 0.35, 0.4, 0.45] #mutualist death chance
...
def munge_file(out_file_name, out_file_header, in_file_prefix) :
    ...
    for seed in seeds :
        for t1 in treatments :
            ...
            s = str(seed) # seed 
            in_file_name = in_file_prefix + "_MUTUALISTDEATH" + dc + "_HOSTDEATH0.5_SEED" + s + ".data"
