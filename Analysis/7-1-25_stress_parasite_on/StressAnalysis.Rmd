...
standard_facet <- facet_grid(size~parasite_death_chance) 
...
```{r}
molten_tasks <- melt(tasks_df, id=c("seed","parasite_death_chance","size", "update"))
...
task_plotter(subset(molten_tasks, host_task==F), 1, "Sym task count", T)
